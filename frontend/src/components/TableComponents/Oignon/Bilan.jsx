...
const Bilan = ({
  ...
  const { idWilaya: id } = user;  const fileName = `${
    t("Bilan de la Production Oignon") + " | " + t(type)
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "dateDebutPlantation",
      title: t("Date du Début de Plantation"),
      type: "date",
    },
            ...
            : {
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idBilan, tableData, ...properties } = newData;
                    fetch("/api/mais/edit", {
                      method: "post",
                      credentials: 'include',
                      headers: {
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/mais/delete/" + oldData.idBilan, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
