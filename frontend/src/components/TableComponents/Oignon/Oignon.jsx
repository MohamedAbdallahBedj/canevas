...
const Oignon = ({
  ...
  const { idWilaya: id } = user;  const fileName = `${
    t("Suivi de la Production Oignon") + " | " + t(type)
  } ${campagne}/${parseInt(campagne) + 1}`;
  const idCategorieLookup = { 5: t("Oignon Vert"), 6: t("Oignon Sec") };
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "superficiePrevuePlantation",
      title: t("Superficie Prévue à la Plantation (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
    ...
    {
      ...baseColumn,
      field: "superficiePrevisionnelle",
      title: t("Production Prévisionnelle (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "RDTPrevisionnelle",
          ...
          exportMenu: [
            {
              ...
              exportFunc: (columns, _, { searchedData }) => {
                ...
                const searchedDataFormated = searchedData.map((row) => ({
                  ...row,
                  idCategorie: idCategorieLookup[row.idCategorie],
        ...
        editable={
          id === 59
            ...
            : {
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/oignon/delete/" + oldData.idSuivi, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
