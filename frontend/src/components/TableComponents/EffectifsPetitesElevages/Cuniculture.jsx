...
const Cuniculture = ({
  ...
  let columns = [
    ...
    },
    {
      ...baseColumn,
      field: "elevageSol",
      title: t("Élevage Au Sol (Tête)"),
      type: "numeric",
      groupTitle: t("Effectif Mis En Place (Sujet)") + ": ",
    },
    {
      ...baseColumn,
      field: "elevageClapier",
      title: t("Élevage En Clapier (Tête)"),
      type: "numeric",
      groupTitle: t("Effectif Mis En Place (Sujet)") + ": ",
    },
    {
      ...baseColumn,
      field: "totalLapin",
      title: t("Total Lapins (Au Sol + En Clapier) (Tête)"),
      type: "numeric",
      groupTitle: t("Effectif Mis En Place (Sujet)") + ": ",
      editable: "never",
      render: (data) => {
  ...
  const CustomHeader = (props) => {
    let tableCells = [
      ...
      { text: "", sx: {}, colSpan: 1 },
      {
        text: t("Effectif Mis En Place (Sujet)"),
