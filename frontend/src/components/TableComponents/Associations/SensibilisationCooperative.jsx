...
const SensibilisationCooperative = ({
  campagne,
  data = [],
  refetch,
  loading = false,
  ...
  const { idWilaya: id } = user;  const fileName = t(
    "Sensibilisation des Professionnels pour la Création de Coopératives Agricoles"
  );
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "vulgarisationSensibilisationAppuiConseil",
      title: t("Vulgarisation, Sensibilisation et Appui conseil"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "activiteRadiophonique",
      title: t("Activités Radiophoniques"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "activiteTelevisuelle",
      title: t("Activités Télévisuelles"),
      type: "numeric",
    },
    {
      ...baseColumn,
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/associations-cooperatives/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "cooperativeSensibilisation",
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idSensibilisation, tableData, ...properties } = newData;
                    fetch("/api/associations-cooperatives/edit", {
                      ...
                      body: JSON.stringify({
                        tablename: "cooperativeSensibilisation",
                        properties,
                        idCol: "idSensibilisation",
                        id: idSensibilisation,
                      }),
                    })
                      .then((response) => {
                        if (!response.ok) {
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/associations-cooperatives/delete/" + oldData.idSensibilisation, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
...
export default SensibilisationCooperative;
