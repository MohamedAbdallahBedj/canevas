...
const Cooperatives = ({ data = [], refetch, loading = false, relation }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;  const fileName = t(
    "Identification de Cooperatives en Etat de Fonctionnement"
  );
  ...
  let columns = [
    ...
    { ...baseColumn, field: "siegeSocial", title: t("Siége Social") },
    { ...baseColumn, field: "objetSocial", title: t("Objet Social") },
    {
      ...baseColumn,
      field: "typeCooperative",
      title: t("Type de Coopérative"),
    },
    ...
    {
      ...baseColumn,
      field: "nomPrenomGerant",
      title: t("Coordonées de Gerant (Nom et Prénom)"),
    },
    {
      ...baseColumn,
      field: "numeroCarteGerant",
      title: t("Coordonées de Gerant (N° de la Carte Professionnelle)"),
    },
    {
      ...baseColumn,
      field: "telephoneGerant",
      title: t("Coordonées de Gerant (N° Téléphone)"),
      validate: (rowData) => {
        const regex = new RegExp("([0-9]+(-[0-9]+)+)");
        return regex.test(rowData.telephoneGerant);
      },
      initialEditValue: "00-00-00-00-00",
    },
    {
      ...baseColumn,
      field: "nombreAdherants",
    ...
    {
      ...baseColumn,
      field: "inventairePatrimoineMobileImmobile",
      title: t("Inventaire du Patrimoine  Mobile et Immobile"),
    },
    {
      ...baseColumn,
      field: "situationFinanciere",
      title: t("Situation Financière"),
    },
            ...
            : {
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idCooperative, tableData, ...properties } = newData;
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/associations-cooperatives/delete/" + oldData.idCooperative, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
