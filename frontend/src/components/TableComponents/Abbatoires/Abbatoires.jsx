...
const Abbatoires = ({ data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;
  const fileName = t(
    "Identification des Abattoirs et des Tueries Par Espece Animale"
  );
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "nomProprietere",
      title: t("Nom du Propriétaire de l'Abattoir"),
    },
    {
      ...baseColumn,
      field: "nomExploitant",
      title: t("Nom de l'Exploitant"),
    },
    {
      ...baseColumn,
      field: "capaciteTJ",
      title: t("Capacité de l'Abattoir (Tête/Jour)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "capaciteKJ",
      title: t("Capacité de l'Abattoir (Kg/Jour)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "especeAnimaleAbattue",
      title: t("Espèce Animale Abattue"),
    },
    {
      ...baseColumn,
      field: "addresse",
