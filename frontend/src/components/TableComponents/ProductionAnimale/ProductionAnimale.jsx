...
const ProductionAnimale = ({
  ...
  let columns = [
    ...
    },
    {
      ...
      field: "annee",
      title: t("Année"),
      lookup: Object.fromEntries(entries),
    },
    {
      ...baseColumn,
      field: "viandeRouge",
      title: t("Viande Rouge (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "viandeBlanche",
      title: t("Viande Blanche (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "lait",
      title: t("Lait (10³ Litres)"),
      type: "numeric",
    },
    {
      ...baseColumn,
...
export default ProductionAnimale;
