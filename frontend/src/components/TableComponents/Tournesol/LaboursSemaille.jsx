...
const LaboursSemaille = ({ campagne, data = [], refetch, loading = false }) => {
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "superficieFertilisee",
      title: t("Superficie Fertilisée (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
                ...
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/tournesol/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "tournesolLaboursSemailles",
...
export default LaboursSemaille;
