...
const MoissonBattage = ({ campagne, data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;
  const fileName = t("Suivi de la Campagne Moisson-Battage");
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "superficieSinistree",
      title: t("Superficie Sinistrée (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "situationRecoltee",
      title: t("Superficie Récoltée (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "productionTotale",
      title: t("Production Total (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
    ...
    {
      ...baseColumn,
      field: "quantiteTransformeAlimentBetail",
      title: t("Quantité transformé en Aliment de Bétail(Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "quantiteTransformeGraine",
      title: t("Quantité transformé en Graine(Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "productionHuile",
      title: t("Production d'Huile de Tournesol (Hl)"),
      type: "numeric",
    },
    {
      ...baseColumn,
        ...
        editable={
          id === 59
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/tournesol/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "tounrnesoleMoissonBattage",
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/tournesol/delete/" + oldData.id, {
                      method: "delete",
                      credentials: "include",
                      headers: {
                        "Content-Type": "application/json",
