...
const FilieresAnimales = ({ data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;
  const fileName = t(
    "Identification des filières animales actives dans les wilayas"
  );
  ...
  let columns = [
    ...
    },
    {
      ...baseColumn,
      field: "cuniculture",
      title: t("Cuniculture (Élevage de Lapin)"),
      type: "boolean",
      initialEditValue: false,
    },
    {
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/filieres-animales/add", {
                      method: "post",
                      credentials: "include",
                      headers: {
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/filieres-animales/edit", {
                      method: "post",
                      credentials: "include",
                      headers: {
                        "Content-Type": "application/json",
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/filieres-animales/delete/" + oldData.id, {
                      method: "delete",
                      credentials: "include",
                      headers: {
                        "Content-Type": "application/json",
...
export default FilieresAnimales;
