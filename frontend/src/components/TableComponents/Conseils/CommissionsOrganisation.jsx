...
const CommissionsOrganisation = ({
  ...
  const { idWilaya: id } = user;  const fileName = t(
    "Installation de la Commission pour l’organisation et le suivi des élections"
  );
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "installationCommisionWilaya",
      title: t("Installation de Commission"),
    },
    {
      ...baseColumn,
      field: "numeroDecision",
      title: t("Numéro de Décision"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "dateDecision",
      title: t("Date de Décision"),
      type: "date",
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/conseils-administration/add", {
                      method: "post",
                      credentials: 'include',
                      headers: {
                      ...
                      body: JSON.stringify({
                        tablename: "installationCommissionOrganisationSuiviElections",
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idCommission, tableData, ...properties } = newData;
                    fetch("/api/conseils-administration/edit", {
                      method: "post",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/conseils-administration/delete/" + oldData.idCommission, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
...
export default CommissionsOrganisation;
