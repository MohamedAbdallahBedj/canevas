...
const Renouvellement = ({ campagne, data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;  const fileName = t("Situation de Renouvellement d'Agrement");
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "associationsRenouveles",
      title: t("associationsRenouveles"),
      initialEditValue: 0,
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "associationNonRenouveles",
      title: t("associationNonRenouveles"),
      initialEditValue: 0,
      type: "numeric",
    },
  ];
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/conseils-administration/add", {
                      ...
                      body: JSON.stringify({
                        tablename:
                          "situationRenouvellementAssociations",
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idSituation, tableData, ...properties } = newData;
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/conseils-administration/delete/" + oldData.idSituation, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
