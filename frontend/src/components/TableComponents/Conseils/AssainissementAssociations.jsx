...
const AssainissementAssociations = ({
  campagne,
  data = [],
  refetch,
  loading = false,
  ...
  const { idWilaya: id } = user;  const fileName = t("Associations Professionnelles Agricoles");
  ...
  const territoireLookup = { 1: t("Communal"), 2: t("Wilayal") };
          ...
          exportMenu: [
            {
              ...
              exportFunc: (columns, _, { searchedData }) => {
                ...
                const searchedDataFormated = searchedData.map((row) => ({
                  ...
                  territoire: territoireLookup[row.territoire],
                }));
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/conseils-administration/add", {
                      ...
                      body: JSON.stringify({
                        tablename:
                          "situationAssociationsAgricolesAssainissement",
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idAssociation, tableData, ...properties } = newData;
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/conseils-administration/delete/" + oldData.idAssociation, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
...
export default AssainissementAssociations;
