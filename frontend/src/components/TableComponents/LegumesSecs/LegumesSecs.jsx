...
const LegumesSecs = ({ campagne, data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id, role } = user;
  const fileName = t("Suivi de la Production Legumes Secs");
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "superficieLabouree",
      title: t("Superficie Labourée (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
    ...
    {
      ...baseColumn,
      field: "superficieSemee",
      title: t("Superficie Semmées (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
        ...
        editable={
          id === 59
            ...
            : {
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/legumes-secs/delete/" + oldData.idSuivi, {
                      method: "delete",
                      credentials: "include",
                      headers: {
                        "Content-Type": "application/json",
