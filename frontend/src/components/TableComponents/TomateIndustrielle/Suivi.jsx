...
const Suivi = ({ campagne, data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;  const fileName = t("Suivi de la Production Tomate Industrielle");
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "superficiePrevue",
      title: t("Superficie Prévue (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
    ...
    },
    {
      ...
      title: t("Quantité Produite  (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "quantiteLivree",
      title: t("Quantité Livrée (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
    ...
    {
      ...baseColumn,
      field: "quantiteTransformeeSimple",
      title: t("Quantité Transformée Simple  Concentré (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "quantiteTransformeeDouble",
      title: t("Quantité Transformée Double Concentré (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "quantiteTransformeeTriple",
      title: t("Quantité Transformée Triple Concentré (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "quantiteTransformeeAutre",
      title: t("Quantité Transformée Autre Concentré (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "nombreConserveries",
      title: t("Nombre de Conserveries Actives (Wilaya)"),
      type: "numeric",
    },
        ...
        editable={
          id === 59
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/tomate-industrielle/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "tomateIndustrielleSuivi",
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/tomate-industrielle/delete/" + oldData.idSuivi, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
