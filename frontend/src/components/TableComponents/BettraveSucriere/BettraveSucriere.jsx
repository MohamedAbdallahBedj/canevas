...
const BettraveSucriere = ({
  ...
  const { idWilaya: id } = user;  const fileName = t("Suivi de la Production de Bettrave Sucrière");
  ...
  if (id !== 59) columns = columns.filter((column) => column.field !== "idWilaya");
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/bettrave-sucriere/add", {
                      method: "post",
                      credentials: 'include',
                      headers: {
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/bettrave-sucriere/edit", {
                      method: "post",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/bettrave-sucriere/delete/" + oldData.id, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
...
export default BettraveSucriere;
