...
const PlanAction = ({ campagne, data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;
  const fileName = t("Plan d'actions");
  ...
  let columns = [
    ...
    },
    {
      ...baseColumn,
      field: "moyens",
      title: t("Moyens qui doit être mobilisés"),
    },

    {
      ...baseColumn,
      field: "objectifs",
      title: t("Objectifs ciblés"),
      groupTitle: t("Objectifs ciblés et resultats attendus") + ": ",
    },
    {
      ...baseColumn,
      field: "resultats",
      title: t("Resultats attendus"),
      groupTitle: t("Objectifs ciblés et resultats attendus") + ": ",
    },
    {
      ...baseColumn,
  ...
  const CustomHeader = (props) => {
    let tableCells = [
      ...
      { text: "", sx: {}, colSpan: 1 },
      {
        text: t("Objectifs ciblés et resultats attendus"),
        sx: { textAlign: "center", backgroundColor: "#d3d3d3" },
        colSpan: 2,
      },
      { text: "", sx: {}, colSpan: 1 },
