...
const DPA = ({ data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;  const fileName = t("Chambres froides par produit d'origine animale");
  ...
  let columns = [
    ...
    },
    {
      ...
      title: t("Numero d'agrément"),
    },
    {
      ...baseColumn,
      field: "nomOperateurStockeur",
      title: t("Nom de l'Opérateur Stockeur"),
    },
    {
      ...baseColumn,
      field: "produitStocke",
      title: t("Produits Stockés"),
    },
    {
      ...baseColumn,
      field: "nombreChambresFroides",
      title: t("Nombre de Chambres Froides"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "capaciteStockage",
      title: t("Capacité de Stockage (M³)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "quantite",
      title: t("Quantité Stockée (Tonne)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "modeStockage",
      title: t("Mode de Stockage"),
    },
    {
      ...baseColumn,
      field: "lieux",
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/chambres-froides-origine-animale/add", {
                      method: "post",
                      credentials: 'include',
                      headers: {
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idChambre, tableData, ...properties } = newData;
                    fetch("/api/chambres-froides-origine-animale/edit", {
                      method: "post",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/chambres-froides-origine-animale/delete/" + oldData.idChambre, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
