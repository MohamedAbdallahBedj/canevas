...
const Triticale = ({ data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;  const fileName = t(
    "Identification des Producteurs de la Culture de Triticale"
  );
  ...
  let columns = [
    ...
    { align: "center", field: "name", title: t("Nom et Prénom de Producteur") },
    {
      align: "center",
      field: "superficieCultivee",
      title: t("Superficie Cultivée (Ha)"),
      type: "numeric",
    },
    {
      align: "center",
      field: "superficieRecoltes",
      title: t("Superficie Récoltés (Ha)"),
      type: "numeric",
    },
    {
      align: "center",
        ...
        editable={
          id === 59
            ...
            : {
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/indentification-producteurs/delete/" + oldData.idProducteur, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
