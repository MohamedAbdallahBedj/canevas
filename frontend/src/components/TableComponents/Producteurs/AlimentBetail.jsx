...
const AlimentBetail = ({ data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;  const fileName = t("Identification des Fabricants d'Aliment de Betail");

  const typeAlimentFabriqueLookup = {
    1: t("Avicole"),
    2: t("Ovins"),
    3: t("Bovins"),
  };
  ...
  let columns = [
    ...
    {
      align: "center",
      field: "numeroAgrement",
      title: t("N° d'Agrément"),
      type: "numeric",
    },
    {
      align: "center",
      field: "nomGerantUniteFAB",
      title: t("Nom et Prénom du Gérant de l'Unité FAB"),
    },
    { align: "center", field: "raisonSocial", title: t("Raison Social") },
    {
      align: "center",
      field: "capaciteUnite",
      title: t("Capacité de l'Unité (Qx/Jour)"),
      type: "numeric",
    },
    {
      align: "center",
      field: "typeAlimentFabrique",
      title: t("Type d'Aliment Fabriqué"),
      lookup: typeAlimentFabriqueLookup,
    },
    {
      align: "center",
      field: "compositionAlimentFabrique",
      title: t("Composition de l'Aliment Fabriqué"),
    },
    {
      ...baseColumn,
      field: "date",
          ...
          exportMenu: [
            {
              ...
              exportFunc: (columns, _, { searchedData }) => {
                ...
                const searchedDataFormated = searchedData.map((row) => ({
                  ...
                  typeAlimentFabrique: typeAlimentFabriqueLookup[row.typeAlimentFabrique],
                }));
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/indentification-producteurs/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "fabricantAlimentBetail",
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idFabricant, tableData, ...properties } = newData;
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/indentification-producteurs/delete/" + oldData.idFabricant, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
