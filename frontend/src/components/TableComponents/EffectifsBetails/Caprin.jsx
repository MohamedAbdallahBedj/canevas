...
const Caprin = ({
  ...
  const { idWilaya: id } = user;  const fileName = t("Effectif Caprin");
  ...
  let columns = [
    ...
    },
    {
      ...baseColumn,
      field: "chevreaux",
      title: t("Chevreaux (Moins De 6 Mois)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "chevrettes",
      title: t("Chevrettes (Moins De 6 Mois)"),
      type: "numeric",
    },
    {
      ...baseColumn,
