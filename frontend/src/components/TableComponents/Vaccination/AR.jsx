...
const AR = ({ campagne, data = [], refetch, loading = false }) => {
  ...
  const nombreDeLookup = {
    ...
    3: t("Sujets Vaccines Ovins"),
    4: t("Sujets Vaccines Caprins"),
    5: t("Mortalité Bovine"),
    6: t("Mortalité Ovine et Caprine"),
    7: t("Vétérinaires Étatiques Mobilisés"),
    8: t("Vétérinaires Privés Mobilisés"),
  };
