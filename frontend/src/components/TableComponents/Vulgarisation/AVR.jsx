...
const AVR = ({
  ...
  const { idWilaya: id } = user;  const fileName = t("Activités de Vulgarisation Rapprochées");
  const idFiliereLookup = {
    1: t("Cereal Et Legumes Secs"),
    2: t("Fourrage"),
    3: t("Maraichage"),
    4: t("Arboriculture"),
    5: t("Agrumes"),
    ...
    10: t("Elevage Equins"),
    11: t("Elevage Caprin"),
    12: t("Elevage Camelin"),
    13: t("Elevage Apicole"),
    14: t("Elevage Avicole"),
    15: t("Elevage Caprin"),
    16: t("Culture Oleiageneuse"),
    17: t("Figue de Barbarie"),
    18: t("Dattes"),
    19: t("Safran"),
    20: t("Autres"),
  };
  const idTypeLookup = {
    1: t("Vulgarisation en salle "),
    2: t("Visites-conseils "),
    3: t("Actions de formation"),
  };
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "intitulePrecisTheme",
      title: t("Intitulé précis du thème "),
    },
    {
      ...baseColumn,
      field: "nombreSeancesPrevues",
      type: "numeric",
      title: t("Nbre de séances prévues"),
    },
    {
      ...baseColumn,
      field: "date",
    ...
    {
      ...baseColumn,
      field: "supportsUtilises",
      title: t("Supports Utilisés"),
    },
  ];
  if (id !== 59)
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/vulgarisation/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "activiteVulgarisationRapprochee",
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idActivite, tableData, ...properties } = newData;
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/vulgarisation/delete/" + oldData.idActivite, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
