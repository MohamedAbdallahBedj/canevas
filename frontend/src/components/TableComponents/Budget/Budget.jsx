...
const Budget = ({
  ...
  let columns = [
    ...
    },
    {
      ...
      title: t("Montant réalisé l’année précédente (DA)"),
      type: "numeric",
    },
    {
      ...baseColumn,
    ...
    },
    {
      ...
      field: "differences",
      title: t(
        "Différences entre le montant réalisé l’année précédente et le montant estimé pour l’année en cours (Da)"
      ),
      type: "numeric",
      editable: "never",
      render: (props) => {
        return props.montantEstime - props.montantRealise;
      },
    },
    {
      ...baseColumn,
      field: "commentaire",
      title: t("Commentaire sur la différence"),
    },
