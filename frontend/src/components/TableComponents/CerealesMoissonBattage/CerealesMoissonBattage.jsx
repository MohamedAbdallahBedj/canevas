...
const CerealesMoissonBattage = ({
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "quantiteLivreeCCLS",
      title: t("Quantité Livrée à la CCLS (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
    ...
    {
      ...baseColumn,
      field: "problemesRencontrees",
      title: t("Problèmes Rencontrés"),
    },
  ];
  if (id !== 59)
                ...
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/cereales/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "suiviMoissonBattageCereales",
...
export default CerealesMoissonBattage;
