...
const IrrigationCerealicultures = ({
  campagne,
  data = [],
  refetch,
  loading = false,
  ...
  const { idWilaya: id } = user;  const fileName = t("Irrigation d'Appoint de la Cerealiculture");
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "superficieTotaleEmblavee",
      title: t("Superficie Totale Emblavée (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "superficieTotaleIrrigueeAppoint",
      title: t("Superficie Totale Irriguée (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      groupTitle: t("Matériel d'Irrigation") + ": ",
      field: "materielIrrigationKitAspersion",
      title: t("Kit Aspersion"),
      type: "numeric",
    },
    {
      ...baseColumn,
      groupTitle: t("Matériel d'Irrigation") + ": ",
      field: "materielIrrigationPivot",
      title: t("Pivot"),
      type: "numeric",
    },
    {
      ...baseColumn,
      groupTitle: t("Matériel d'Irrigation") + ": ",
      field: "materielIrrigationEnrouleur",
      title: t("Enrouleur"),
      type: "numeric",
    },
    {
      ...baseColumn,
      groupTitle: t("Sources d'Irrigation") + ": ",
      field: "sourceIrrigationGPI",
      title: t("Grands Périmètres Irrigués"),
      type: "numeric",
    },
    {
      ...baseColumn,
      groupTitle: t("Sources d'Irrigation") + ": ",
      field: "sourceIrrigationPMH",
      title: t("Petite et Moyenne Hydraulique"),
      type: "numeric",
    },
    {
      ...baseColumn,
      groupTitle: t("Sources d'Irrigation") + ": ",
      field: "sourceIrrigationAutres",
      title: t("Autres"),
      type: "numeric",
    },
    {
  ...
  const CustomHeader = (props) => {
    let tableCells = [
      ...
      { text: "", sx: {}, colSpan: 1 },
      {
        text: t("Matériel d'Irrigation"),
        sx: { textAlign: "center", backgroundColor: "#d3d3d3" },
        colSpan: 3,
      },
      {
        text: t("Sources d'Irrigation"),
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/irrigation-appoint/add", {
                      method: "post",
                      credentials: 'include',
                      headers: {
                      ...
                      body: JSON.stringify({
                        tablename: "irrigationAppointCerealiculture",
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/irrigation-appoint/edit", {
                      method: "post",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/irrigation-appoint/delete/" + oldData.id, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
...
export default IrrigationCerealicultures;
