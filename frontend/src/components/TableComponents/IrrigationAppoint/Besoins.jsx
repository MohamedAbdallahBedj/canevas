...
const Besoins = ({ campagne, data = [], refetch, loading = false }) => {
  const { t } = useTranslation();
  const { user } = React.useContext(AuthContext);
  const { idWilaya: id } = user;  const fileName = t("Besoins en Eau d'Irrigation des Cultures");
  const idCulturesLookup = {
    1: t("Céréales"),
    2: t("Pomme de Terre"),
    3: t("Agrumes"),
    4: t("Olivier"),
  ...
  let columns = [
    ...
    },
    {
      ...
      field: "idCulture",
      title: t("Culture"),
      lookup: idCulturesLookup,
    },
    {
      ...baseColumn,
      field: "superficieAIrriguer",
      title: t("Superficie à Irriguer (Ha)"),
      type: "numeric",
    },
    {
      ...baseColumn,
    ...
    },
    {
      ...baseColumn,
      field: "volumeDemande",
      title: t("Volume Demandé (m3)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "volumeAccorde",
      title: t("Volume Accordé (m3)"),
      type: "numeric",
    },
    {
      ...baseColumn,
    ...
    { ...baseColumn, field: "contraintes", title: t("Contraintes") },
  ];
  if (id !== 59)
          ...
          exportMenu: [
            {
              ...
              exportFunc: (columns, _, { searchedData }) => {
                ...
                const searchedDataFormated = searchedData.map((row) => ({
                  ...
                  idCulture: idCulturesLookup[row.idCulture],
                }));
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/irrigation-appoint/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "besoinsEauIrrigationCultures",
                ...
                onRowUpdate: (newData, oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    const { idBesoin, tableData, ...properties } = newData;
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/irrigation-appoint/delete/" + oldData.idBesoin, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
