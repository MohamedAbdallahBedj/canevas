...
const ProduitsPhytosanitaires = ({
  ...
  const { idWilaya: id } = user;  const fileName = t(
    "Liste des Agriculteurs Potentiels qui Utilisent les Produits Phytosanitaires"
  );
                ...
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/autres-canevas/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "produitsPhytosanitaires",
...
export default ProduitsPhytosanitaires;
