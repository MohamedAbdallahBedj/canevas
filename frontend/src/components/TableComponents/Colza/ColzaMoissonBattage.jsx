...
const ColzaMoissonBattage = ({
  ...
  const { idWilaya: id } = user;  const fileName = t("Suivi de la Campagne Moisson-Battage Colza");
  const idEspeceLookup = {
    1: t("Colza (Consommation)"),
    2: t("Colza (Semences)"),
  };
  ...
  let columns = [
    ...
    {
      ...baseColumn,
      field: "quantiteTransformeeBetail",
      title: t("Quantité Transformée Aliment de Bétail (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "quantiteTransformeeGraines",
      title: t("Quantité Transformée Graines (Qx)"),
      type: "numeric",
    },
    {
      ...baseColumn,
      field: "productionHuileColza",
      title: t("Production d'Huile de Colza (Hl)"),
      type: "numeric",
    },
        ...
        editable={
          id === 59
            ...
            : {
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    ...
                    fetch("/api/colza/add", {
                      ...
                      body: JSON.stringify({
                        tablename: "suiviMoissonBattageColza",
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    fetch("/api/colza/delete/" + oldData.idSuivi, {
                      method: "delete",
                      credentials: 'include',
                      headers: {
                        "Content-Type": "application/json",
...
export default ColzaMoissonBattage;
