...
import CulturesFourrageres from "../components/TableComponents/CulturesFourrageres/CulturesFourrageres";

const CulturesFourrageresPage = ({ campagnes }) => {
...
const { idWilaya:id } = user;
  ...
  var searchParams = { table: "suiviCulturesFourrageres", annee: campagne };
  const { data, loading, error, refetch } = useFetch(
    "/api/cultures-fourrageres/table",
    "GET",
...
export default CulturesFourrageresPage;
