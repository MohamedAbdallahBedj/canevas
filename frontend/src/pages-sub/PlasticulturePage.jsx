...
import Plasticulture from "../components/TableComponents/Plasticulture/Plasticulture";

const PlasticulturePage = ({ campagnes }) => {
...
const { idWilaya:id } = user;
  ...
  var searchParams = { table: "plasticultureSuivi", annee: campagne };
  const { data, loading, error, refetch } = useFetch(
    "/api/plasticulture/table",
    "GET",
...
export default PlasticulturePage;
