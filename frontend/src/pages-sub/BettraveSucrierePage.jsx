...
import BettraveSucriere from "../components/TableComponents/BettraveSucriere/BettraveSucriere";

const BettraveSucrierePage = ({ campagnes }) => {
...
const { idWilaya:id } = user;
  ...
  var searchParams = { table: "bettraveSucriere", annee: campagne };
  const { data, loading, error, refetch } = useFetch(
    "/api/bettrave-sucriere/table",
    "GET",
...
export default BettraveSucrierePage;
