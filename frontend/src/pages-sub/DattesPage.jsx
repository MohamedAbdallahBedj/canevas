...
import Dattes from "../components/TableComponents/Dattes/Dattes";

const DattesPage = ({ campagnes }) => {
...
const { idWilaya:id } = user;
  ...
  var searchParams = { table: "dattesSuivi", annee: campagne };
