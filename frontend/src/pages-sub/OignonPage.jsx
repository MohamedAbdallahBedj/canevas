...
import Oignon from "../components/TableComponents/Oignon/Oignon";
import Bilan from "../components/TableComponents/Oignon/Bilan";
...
const OignonPage = ({ campagnes }) => {
  ...
  // Suivis
  var searchParamsS = {
    table: "oignonSuivi" + value.suffix,
    annee: campagne,
  };
  ...
  return (
    <>
      ...
      <Oignon
        type={value.label}
        relation={"oignonSuivi" + value.suffix}
        campagne={campagne}
        data={suivi?.data}
