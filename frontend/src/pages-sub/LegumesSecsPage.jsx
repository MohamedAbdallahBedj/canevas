...
import LegumesSecs from "../components/TableComponents/LegumesSecs/LegumesSecs";

const LegumesSecsPage = ({ campagnes }) => {
...
const { idWilaya:id } = user;
  ...
  var searchParams = { table: "legumesSecsSuivi", annee: campagne };
  const { data, loading, error, refetch } = useFetch(
    "/api/legumes-secs/table",
    "GET",
...
export default LegumesSecsPage;
