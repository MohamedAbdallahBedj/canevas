...
import Agrumes from "../components/TableComponents/Agrumes/Agrumes";

const AgrumesPage = ({ campagnes }) => {
...
const { idWilaya:id } = user;
  ...
  var searchParams = { table: "agrumesSuivi", annee: campagne };
